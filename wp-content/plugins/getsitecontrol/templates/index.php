    ...
    <div class="block block-sign-up-form block-sign-up-form_tint-action odd">
        <section class="sign-up-form selected-toggled-block">
            <div class="form-contents tint-action">
                ...
                <a href="<?php echo $add_site_link; ?>" target="_blank" class="button button-fill-default add-site disabled">
                    Add new site
                </a>
            </div>
        </section>
        ...
        <div class="bottom-manage-block">
            <div class="gotodashboard-block">
                <a href="javascript:void(0);" class="button button-fill-active manage-widget-link disabled manage__button-text" target="_blank">
                                Go to Dashboard
                </a>
            </div>
        </div>
