    ...
    <div class="block block-sign-up-form block-sign-up-form_tint-action odd">
        <section class="sign-up-form">
            <div class="form-contents tint-action">
                ...
                <form novalidate
                    method="post"
                    action="<?php echo $options['api_url']; ?>"
                    data-form-validate="">
                        ...
                        <div class="form-wrapper">
                            ...
                            <div class="field-row">
                                ...
                                <input tabindex="3" class="form-control" title="Enter your site" required=""
                                       ...
                                       value="<?php echo !empty($data['site']) ? $data['site'] : ''; ?>">
                                <span class="form-validation-message"></span>
                            </div>
                        </div>
            ...
            <div class="form-social-footer">
                <div class="social-login">
                    <a tabindex="5"
                       href="<?php echo $options['fb_social_link']; ?>"
                       class="button social-login-button social-login-facebook">
                        <span class="icon icon_facebook"></span>
                        Facebook
                    </a>
                    <a tabindex="6"
                       href="<?php echo $options['google_social_link']; ?>"
            ...
            <p class="form-have-account">
                Already have an account?&nbsp; <a tabindex="7" href="<?php echo $sign_in_link; ?>">Sign In</a>
            </p>
        </section>
    </div>
        ...
        <div class="features">
            ...
            <article class="feature">
                ...
                <p>You can upgrade any time if you need advanced features, want to manage several websites or invite
                    additional users. <a target="_blank" href="https://getsitecontrol.com/pricing/">Paid plans</a> start at $10/month.</p>
            </article>
        </div>
    </div>
    ...
    <div class="block block-faq last even">
        <div class="faqs">
            ...
            <article class="faq">
                ...
                <p><a target="_blank" href="https://getsitecontrol.com/pricing/">All subscription plans</a> allow unlimited survey responses, subscribers and form
                    submissions.</p>
            </article>
        </div>
    </div>
...
<script>
    var GSC_OPTIONS = <?php echo json_encode($options); ?>;
</script>
