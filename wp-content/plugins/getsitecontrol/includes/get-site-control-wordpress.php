...
class GetSiteControlWordPress {
    ...
    public static function add_script() {
        if( !empty(self::$settings['widget_link']) ) {
            //wp_enqueue_script('gsc_loader_script', GSC_URL . 'templates/js/get-site-control-loader.js', '', self::$version);
            //wp_localize_script('gsc_loader_script', 'gsc_loader_script_options', array('widget_link' => self::$settings['widget_link']));
    ...
    public static function action_admin_menu_sign_out() {
        ...
        self::render_template('sign_out', array(
            'options' => $options
        ));
    }
    ...
    public static function action_admin_menu_sign_up() {
        ...
        $socialParams =
            ...
            '&timezone_name=' . urlencode($options['timezone_name']) .
